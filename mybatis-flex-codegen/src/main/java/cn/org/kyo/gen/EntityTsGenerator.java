 ...
 * @since 2025-08-15
 */
public class EntityTsGenerator implements IGenerator {

    private String templatePath = "/templates/enjoy/entity.ts.tpl";
    ...
    public void generate(Table table, GlobalConfig globalConfig) {
        ...
        File file = new File(packageConfig.getSourceDir(), path + "/entity/" + table.getName() + ".ts");
